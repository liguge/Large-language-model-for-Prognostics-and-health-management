...
| 11   | <font color= #0000FF>Survey on Foundation Models for Prognostics and Health Management in Industrial Cyber-Physical Systems</font> | 工业网络物理系统中预测性健康管理的基础模型综述               |
...
| 43   | <font color= #0000FF>面向机械设备通用健康管理的智能运维大模型</font> | 面向机械设备通用健康管理的智能运维大模型                     |
